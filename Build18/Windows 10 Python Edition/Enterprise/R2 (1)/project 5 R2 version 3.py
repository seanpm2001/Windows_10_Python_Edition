...
#*********************************************
#Answer: I have seen A LOT of windows Parodies made by kids from 2002-2009 on YouTube, and
#there are a lot of misconceptions. They were funny at the time (to some people) but these
...
#People about fake and non-existant file formats (as of this date: 6.6.2018)
...
#take further development on. It was originally made on www.py3.codeskulptor.org as an
#Assignment for animation. I think it counts as animation, since it is also interactive
#Other than movements. This took about 1-2 hours a day from May 23rd to June 6th, but
...
your_video_:_family_photos_compilation_dot_mp4_failed_to_render_error = object
...
frame.start()    
frame = simplegui.create_frame('Project 5: Animation - Alpha 3 (python) ', 1670, 850)
