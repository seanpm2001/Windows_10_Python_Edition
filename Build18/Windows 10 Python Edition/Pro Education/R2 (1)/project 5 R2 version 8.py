...
#people about fake and non-existant file formats (as of this date: 6.8.2018)
...
frame.start()    
frame = simplegui.create_frame('Windows 10 Python Edition - Alpha 7 (python) ', 1670, 850)
frame.set_canvas_background("Grey")
frame.set_draw_handler(draw_handler)
frame.start()
print ("0 [- User Output and Help Log Version 17 (june 11th 2018 build) -]")
...
print ("58 Total lines of code 1577 (internal) outputted for user 108 (still from within the same 1577 lines of code)")
...
print ("107 added new documents to research
def draw (canvas):
    global x
    x = x + 10
