...
frame.set_draw_handler(draw_handler)
frame.start()
print ("0 [- User Output and Help Log Version 15 (june 8th 2018 build) -]")
...
print ("58 Total lines of code 542 (internal) outputted for user 82 (still from within the same 542 lines of code)")
