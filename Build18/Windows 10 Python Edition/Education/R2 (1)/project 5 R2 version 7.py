...
frame.start()    
frame = simplegui.create_frame('Windows 10 Python Edition - Alpha 5.1 (python) ', 1670, 850)
frame.set_canvas_background("Grey")
frame.set_draw_handler(draw_handler)
frame.start()
print ("0 [- User Output and Help Log Version 15.1 (true june 8th 2018 build) -]")
...
print ("13 Program: Version: 9.5.1")
...
print ("58 Total lines of code 1573 (internal) outputted for user 104 (still from within the same 1573 lines of code)")
